import { hasAnthropicKey } from "@/ai";
    ...
    <div className="flex flex-1 flex-col items-center justify-center px-6 py-10">
      ...
      <div className="mt-5 w-full max-w-[300px] space-y-2">
        <button
          ...
          className="block w-full rounded-xl border-2 border-violet-300 bg-violet-50 px-4 py-3 text-left"
        >
          <div className="text-sm font-semibold text-violet-900">✨ Tell the Composer one thing</div>
          <div className="text-[11px] text-violet-700">
            {hasKey
              ? "Compose a roadmap conversationally"
              : "Paste your Anthropic key in ⋯ Settings first"}
          </div>
        </button>
